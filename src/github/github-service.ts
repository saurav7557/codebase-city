    ...
    await prisma.$transaction(
      repositories.map((repository) =>
        prisma.gitHubRepository.upsert({
          ...
          update: toRepositoryPersistenceData(repository),
          create: toRepositoryPersistenceData(repository),
        }),
      ),
    );
...
function toRepositoryPersistenceData(repository: GitHubRepository) {
  return {
